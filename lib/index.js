  ...
  _createClass(Syzygys, [{
    ...
    value: function sortFeedItems(feedItems) {
      return feedItems.sort(function (a, b) {
        return (0, _util.Moment)(b.date.toString).diff((0, _util.Moment)(a.date.toString));
      });
    }
  }, {
    ...
    value: function renderTemplatesWithViewToOutput(templates, view, outputDir) {
      _util.fs.mkdirAsync(outputDir).catch(function () {}).then(function () {
        return templates.forEach(function (templateP) {
